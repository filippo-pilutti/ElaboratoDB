...
public class Cliente {
	...
	public Cliente(final String codFiscale, final String nome, final String cognome, final long telefono, final String mail) {
	...
	public String toString() {
		return "Cliente [codFiscale=" + codFiscale + ", nome=" + nome + ", cognome=" + cognome + ", telefono="
				+ telefono + ", mail=" + mail + "]";
	}
